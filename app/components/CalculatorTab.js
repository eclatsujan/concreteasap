            ...
            <View style={[appStyles.my_5,appStyles.flex1,appStyles.flexRow,appStyles.justifySpace]}>
                ...
                <View>
                    <Button active={!!this.props["fourthButton"]}
                            style={[this.props["fourthButton"] ? appStyles.bgSecondary : {}, appStyles.noBorder]}
                            onPress={() => this.navigate("fourthCalculator", params)}>
                        <Text
                            style={[this.props["fourthButton"] ? appStyles.colorWhite : appStyles.colorBlack,
                                appStyles.arialFont, appStyles.boldFont, appStyles.ft_small]}>
                            Steps
                        </Text>
                    </Button>
