...
class MainSidebar extends React.Component {
    ...
    resetTopNavigation(route, focused) {
        let params=typeof route.route.params!=="undefined"?route.route.params:{};
        if(params.hasOwnProperty("reset")&&params.hasOwnProperty("route")&&params.hasOwnProperty("key")){
            resetNavigation(params["route"],params["key"]);
        }
        else{
    ...
    render() {
        ...
        let textColor=currentComponent==="Reo"?appStyles.colorBlueLgt:appStyles.colorPrimary;
                                          ...
                                          getLabel={(scene) => {
                                              return (
                                                  <View
                                                      style={[appStyles.py_15, appStyles.ml_20, appStyles.borderGray44, appStyles.borderBottom, appStyles.w_100]}>
                                                      <Text
                                                          style={[textColor, appStyles.upperCase, appStyles.boldFont]}>
