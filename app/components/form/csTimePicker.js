...
import {Item as FormItem, Input,Text,Button} from 'native-base';
    ...
    return (
        <View>
            <Button {...inputProps} style={[appStyles.bgWhite,appStyles.mx7]}>
                <Text style={[appStyles.colorGray44,appStyles.defaultFont,appStyles.baseFontSize]}>{input.value?input.value:placeholder}</Text>
