...
export default class ButtonIcon extends React.Component {
    ...
    render() {
        ...
        btnIconSize=this.props["btnIconSize"]?{fontSize:this.props["btnIconSize"]}:btnIconSize;
        ...
        let fontSize=this.props["btnSize"]?{fontSize:this.props["btnSize"]}:appStyles.baseSmallFontSize;
        return (
