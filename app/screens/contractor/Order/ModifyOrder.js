		        ...
		        <Content>
	             	...
	             	<Form>
		              	...
		              	<FormItem floatingLabel>   
	                		...
	                		<Input value={this.state.inputs.suburb.value} style={{fontSize:20}} onChangeText={(value) => {this.onInputChange({ id: "suburb", value:value }); }} />
		              	</FormItem>
		              	...
		              	<Picker mode="dropdown"  iosHeader="Types" iosIcon={<Icon name="arrow-down" />}
		              		selectedValue={this.state.inputs.types} onValueChange={this.onValueChange.bind(this)}  
				        ...
				        <View style={{fontSize:18, marginBottom:15}}>
					        <FormItem floatingLabel>
				              ...
				              <Input value={this.state.inputs.quantity.value} style={{fontSize:20}} onChangeText={(value) => {this.onInputChange({ id: "quantity", value:value }); }} />
				            </FormItem>
			            ...
			            <Grid>
				            ...
				            <FormItem floatingLabel>
				                ...
				                <Input 
				                 ...
				                 onChangeText={(value) => {this.onInputChange({ id: "time1", value:value }); }} />
			                </FormItem>
