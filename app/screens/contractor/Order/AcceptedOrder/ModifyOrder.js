...
export default class ModifyOrder extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            form_data: {
                ...
                slu: [{label: "80", key: 80}, {label: "90", key: 90}, {label: "100", key: 100}, {
                    label: "150",
                    key: 150
                }],
                acc: [{label: "1% Bronze", key: "1%"}, {label: "2% Sliver", key: "2%"}, {label: "3% Gold", key: "3%"}],
                placement_types: [{label: "Chute", key: "Chute", value: "Chute"}, {
                    label: "Line Pump",
                    key: "Line Pump",
                    value: "Line Pump"
                },
                    {label: "Boom Pump", key: "Boom Pump", value: "Boom Pump"}],
                time_difference_deliveries: [{label: "8am-10am", key: "8am-10am"}, {
                    label: "10am-12pm",
                    key: "10am-12pm"
                }, {label: "12pm-2pm", key: "12pm-2pm"}, {label: "2pm-4pm", key: "2pm-4pm"}, {
                    label: "4pm-6pm",
                    key: "4pm-6pm"
                },],
                urgency: [{label: "Immediate", key: "Immediate"}, {label: "With-in 5 days", key: "With-in 5 days"},],
                message_required: [{label: "Yes", key: "Yes"}, {label: "No", key: "No"}],
    ...
    setDate(newDate) {
        ...
        newDate = newDate + 1;
        inputs.chosenDate = newDate.substring(0, 16);
    ...
    _specialRequests() {
        ...
        if (this.state.inputs.suburb.value !== "" && this.state.inputs.quantity.value !== "" && this.state.inputs.time1.value !== "") {
            if (this.state.inputs.message_required == "Yes") {
                this.props.navigation.navigate("ModifySpecialRequest",
                    {formData: this.state.inputs});
            } else {
                this.submitForm();
            }
        }
    ...
    render() {
        //console.log("Placeorder status ",this.state.inputs.chosenDate);
        return (
            <Container>
                <Header>
                    <Left>
                    ...
                    <ScrollView>
                        <Form>
                            ...
                            <FormItem floatingLabel>
                                ...
                                <Input value={this.state.inputs.suburb.value} style={{fontSize: 20}}
                                       onChangeText={(value) => {
                                           this.onInputChange({id: "suburb", value: value});
                                       }}/>
                            </FormItem>
                            <Text>{this.renderError("suburb")}</Text>
                            ...
                            <Picker mode="dropdown" iosHeader="Types" iosIcon={<Icon name="arrow-down"/>}
                                    selectedValue={this.state.inputs.types}
                                    onValueChange={this.onValueChange.bind(this)}
                                    itemTextStyle={{fontSize: 20}}
                                    activeItemTextStyle={{fontSize: 20, fontWeight: 'bold'}}>
                            ...
                            <Grid>
                                <Col>
                                    ...
                                    <Picker mode="dropdown" iosHeader="MPA" iosIcon={<Icon name="arrow-down"/>}
                                            selectedValue={this.state.inputs.mpa}
                                            onValueChange={this.setMapValue.bind(this)}
                                            itemTextStyle={{fontSize: 25, color: '#d00'}}>
                                ...
                                <Col>
                                    ...
                                    <Picker mode="dropdown" iosHeader="AGG" iosIcon={<Icon name="arrow-down"/>}
                                            selectedValue={this.state.inputs.agg}
                                            onValueChange={this.setAggValue.bind(this)}
                                            itemTextStyle={{fontSize: 25, color: '#d00'}}>
                                ...
                                <Col>
                                    ...
                                    <Picker mode="dropdown" iosHeader="SLU" iosIcon={<Icon name="arrow-down"/>}
                                            selectedValue={this.state.inputs.slu}
                                            onValueChange={this.setSluValue.bind(this)}
                                            itemTextStyle={{fontSize: 25, color: '#d00'}}>
                            ...
                            <Grid>
                                <Col>
                                    ...
                                    <Picker mode="dropdown" iosHeader="Acc" iosIcon={<Icon name="arrow-down"/>}
                                            selectedValue={this.state.inputs.acc}
                                            onValueChange={this.setAccValue.bind(this)}
                                            itemTextStyle={{fontSize: 25, color: '#d00'}}>
                                ...
                                <Col>
                                    ...
                                    <Picker mode="dropdown" iosHeader="Placement Type"
                                            iosIcon={<Icon name="arrow-down"/>}
                                            selectedValue={this.state.inputs.placement_types}
                                            onValueChange={this.setPlacementTypesValue.bind(this)}
                                            itemTextStyle={{fontSize: 25, color: '#d00'}}>
                            ...
                            <View style={{fontSize: 18, marginBottom: 15}}>
                                <FormItem floatingLabel>
                                    ...
                                    <Input value={this.state.inputs.quantity.value} style={{fontSize: 20}}
                                           onChangeText={(value) => {
                                               this.onInputChange({id: "quantity", value: value});
                                           }}/>
                                </FormItem>
                                <Text>{this.renderError("quantity")}</Text>
                            </View>
                            <Grid>
                                <Col>
                            ...
                            <FormItem floatingLabel>
                                ...
                                <Input
                                    ...
                                    onFocus={() => {
                                        ...
                                        this.currentTimeSelector = "time1";
                                    }}
                                    onChangeText={(value) => {
                                        this.onInputChange({id: "time1", value: value});
                                    }}/>
                            </FormItem>
                            ...
                            <FormItem floatingLabel>
                                ...
                                <Input
                                    ...
                                    onFocus={() => {
                                        this.TimePicker.open();
                                        this.currentTimeSelector = "time2";
                                    }}
                            ...
                            <FormItem floatingLabel>
                                ...
                                <Input
                                    ...
                                    onFocus={() => {
                                        this.TimePicker.open();
                                        this.currentTimeSelector = "time3";
                                    }}
                            ...
                            <Picker mode="dropdown" iosHeader="time_difference_deliveries"
                                    iosIcon={<Icon name="arrow-down"/>}
                                    selectedValue={this.state.inputs.time_difference_deliveries}
                                    onValueChange={(text) => {
                                        this.setTimeDifferenceDeliveriesValue(text)
                                    }} itemTextStyle={{fontSize: 25, color: '#d00'}}>
                            ...
                            <Picker mode="dropdown" iosHeader="urgency" iosIcon={<Icon name="arrow-down"/>}
                                    selectedValue={this.state.inputs.urgency} onValueChange={(text) => {
                                this.setUrgencyValue(text)
                            }} itemTextStyle={{fontSize: 25, color: '#d00'}}>
                            ...
                            <Picker mode="dropdown" iosHeader="message_required" iosIcon={<Icon name="arrow-down"/>}
                                    selectedValue={this.state.inputs.message_required} onValueChange={(text) => {
                                this.setMessageRequiredValue(text)
                            }} itemTextStyle={{fontSize: 25, color: '#d00'}}>
                            ...
                            <Picker mode="dropdown" iosHeader="site_call" iosIcon={<Icon name="arrow-down"/>}
                                    selectedValue={this.state.inputs.site_call} onValueChange={(text) => {
                                this.setSiteCallValue(text)
                            }} itemTextStyle={{fontSize: 25, color: '#d00'}}>
